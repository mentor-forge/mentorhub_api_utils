...
**Developer Edition:** Domain APIs and this library **validate** JWTs issued by the welcome page / IdP. See [API Standards](https://github.com/agile-learning-institute/mentorhub/blob/main/DeveloperEdition/standards/api_standards.md).
